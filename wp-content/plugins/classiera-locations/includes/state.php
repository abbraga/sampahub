...
{
    add_meta_box( 'state-meta-box-id', 'Provide Related Information', 'state_meta_box_cb', 'states', 'normal', 'high' );
}
...
function state_meta_box_cb( $post )
{
    ...
    <p>
		...
		<div class="state-meta">
			<p><?php esc_html_e('Please paste your all city with comma. (Example : london,purley,redhill)', 'classiera-locations') ?></p>
