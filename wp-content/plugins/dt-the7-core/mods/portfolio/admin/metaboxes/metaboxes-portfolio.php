...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		// details
		array(
			'name'    	=> _x('Show details icons:', 'backend metabox', 'dt-the7-core'),
		...
		// links
		array(
			'name'    	=> _x('Show links icons:', 'backend metabox', 'dt-the7-core'),
		...
		// zoom
		array(
			'name'    	=> _x('Show zoom icons:', 'backend metabox', 'dt-the7-core'),
			'id'      	=> "{$prefix}show_zoom",
			'type'    	=> 'radio',
			'std'		=> '1',
			'options'	=> $yes_no_options,
...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		array(
			'name'    		=> _x('Open images in lightbox:', 'backend metabox', 'dt-the7-core'),
		...
		array(
			...
			'before'	=> '<p><small>' . sprintf(
				...
				'</a>'
			) . '</small></p><div class="dt_hr"></div><p><strong>' . _x('Project Preview Options', 'backend metabox', 'dt-the7-core') . '</strong></p>'
		),
